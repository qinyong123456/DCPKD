...
class ImageNet(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        # [PromptKD_DPC] Subsample loader using DPC Setting: Load base-class only in tuning stage
            ...
            if cfg.TRAINER.MODAL == "base2novel":
                train_x, _ = OxfordPets.subsample_classes(train, test, subsample=subsample)
                _, test_base = OxfordPets.subsample_classes(train, test, subsample='base')
    ...
    @staticmethod
    def read_classnames(text_file):  # Get all class name
        ...
        return classnames  # An array, values are [foldname: classname]

    def read_data(self, classnames, split_dir):
        split_dir = os.path.join(self.image_dir, split_dir)  # train, val
